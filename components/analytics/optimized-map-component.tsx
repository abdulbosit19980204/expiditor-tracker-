...
const OptimizedMapComponent = memo<OptimizedMapComponentProps>(
  ({ checks, selectedExpeditor, loading, onCheckClick, focusLocation }) => {
      ...
      const init = async () => {
        try {
          ...
          await Promise.race([
            ...
            new Promise<void>((_, reject) => setTimeout(() => reject(new Error("Yandex Maps timeout")), 10000)),
          ])
            ...
            try {
              ...
              const placemark = new window.ymaps.Placemark(
                ...
                `,
                  ...
                  iconColor:
                    check.status === "delivered" ? "#22c55e" : check.status === "pending" ? "#f59e0b" : "#ef4444",
                },
                {
