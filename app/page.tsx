...
import { Search, Users, MapPin, Receipt, Filter, ChevronDown, ChevronUp, X } from "lucide-react"
...
export default function ExpeditorTracker() {
  ...
  const filteredExpeditors = expeditors.filter((expeditor) => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="flex h-screen">
                ...
                <div className="mt-3 space-y-3 p-3 bg-gray-50 rounded-lg">
                  ...
                  <div>
                    ...
                    <Select
                      value={filters.sklad}
                      onValueChange={(value) =>
                        setFilters((prev) => ({ ...prev, sklad: value === "all" ? "" : value }))
                      }
                    >
                      <SelectTrigger className="h-8">
        ...
        {/* Right Sidebar - Statistics and Checks */}
