...
const CHART_COLORS = [
  "#2563eb",      // Blue - better contrast
  "#059669",      // Green - better contrast
  "#d97706",      // Orange - better contrast
  "#dc2626",      // Red - better contrast
  "#7c3aed",      // Purple - better contrast
  "#db2777",      // Pink - better contrast
  "#4f46e5",      // Indigo - better contrast
  "#0d9488",      // Teal - better contrast
]
...
function SimpleAnalyticsPageContent() {
  ...
  const paymentChartData = useMemo(() => {
    ...
    const paymentData = [
      { name: t('cash'), value: statistics.paymentMethods.nalichniy, color: CHART_COLORS[0] },
      { name: t('uzcard'), value: statistics.paymentMethods.uzcard, color: CHART_COLORS[1] },
      { name: t('humo'), value: statistics.paymentMethods.humo, color: CHART_COLORS[2] },
      { name: t('click'), value: statistics.paymentMethods.click, color: CHART_COLORS[3] },
                    ...
                    <CardContent>
                      <ResponsiveContainer width="100%" height={300}>
                        <BarChart data={hourlyChartData}>
                          ...
                          <YAxis />
                          <Tooltip content={<CustomTooltip />} />
                          <Bar dataKey={chartModes.hourlyStats === 'count' ? 'checks' : 'sum'} fill={CHART_COLORS[1]} />
                        </BarChart>
                      </ResponsiveContainer>
                    </CardContent>
                  </Card>
                ...
                <CardContent>
                  <ResponsiveContainer width="100%" height={400}>
                    <BarChart data={expeditorChartData}>
                      ...
                      <Bar dataKey={chartModes.topExpeditors === 'count' ? 'checks' : 'sum'} fill={CHART_COLORS[2]} />
                    </BarChart>
                  </ResponsiveContainer>
                </CardContent>
              </Card>
                  ...
                  <CardContent>
                    <ResponsiveContainer width="100%" height={300}>
                      <BarChart data={projectChartData}>
                        ...
                        <YAxis />
                        <Tooltip content={<CustomTooltip />} />
                        <Bar dataKey={chartModes.topProjects === 'count' ? 'checks' : 'sum'} fill={CHART_COLORS[3]} />
                      </BarChart>
                    </ResponsiveContainer>
                  </CardContent>
                </Card>
                  ...
                  <CardContent>
                    <ResponsiveContainer width="100%" height={300}>
                      <BarChart data={cityChartData}>
                        ...
                        <YAxis />
                        <Tooltip content={<CustomTooltip />} />
                        <Bar dataKey={chartModes.topCities === 'count' ? 'checks' : 'sum'} fill={CHART_COLORS[4]} />
                      </BarChart>
                    </ResponsiveContainer>
                  </CardContent>
                </Card>
                ...
                <CardContent>
                  <ResponsiveContainer width="100%" height={300}>
                    <BarChart data={warehouseChartData}>
                      ...
                      <YAxis />
                      <Tooltip content={<CustomTooltip />} />
                      <Bar dataKey={chartModes.warehouseDistribution === 'count' ? 'checks' : 'sum'} fill={CHART_COLORS[5]} />
                    </BarChart>
                  </ResponsiveContainer>
                </CardContent>
              </Card>
