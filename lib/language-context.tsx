...
const translations = {
  uz: {
    ...
    'daily_statistics_2025': 'Kunlik statistika (2025)',
    'filters': 'Filterlar',
    ...
    'minimum_checks': 'Minimal cheklar',
    'maximum_checks': 'Maksimal cheklar',
  ...
  ru: {
    ...
    'daily_statistics_2025': 'Ежедневная статистика (2025)',
    'filters': 'Фильтры',
    'date_from': 'Дата от',
    'date_to': 'Дата до',
    ...
    'minimum_checks': 'Минимальные чеки',
    'maximum_checks': 'Максимальные чеки',
  ...
  en: {
    ...
    'daily_statistics_2025': 'Daily Statistics (2025)',
    'filters': 'Filters',
    'date_from': 'Date From',
    'date_to': 'Date To',
    'expeditor': 'Expeditor',
    ...
    'minimum_checks': 'Minimum Checks',
    'maximum_checks': 'Maximum Checks',
