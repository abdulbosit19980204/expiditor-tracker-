...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # Create Projects
        projects = [
            {'project_name': 'AVON', 'project_description': 'AVON tovalarini yetkazib berish'},
            {'project_name': 'EVYAP', 'project_description': 'EVYAP tovalarini yetkazib berish'},
        ...
        skladlar = [
            ...
            {'sklad_name': 'SAMARQAND Sklad', 'sklad_code': 'SS008'},
        ]
